...
<nav class="w3-sidenav w3-white w3-card-2 w3-animate-left" style="display:none;z-index:2" id="mySidenav">
  ...
  <a href="#">Link 5</a>
        ...
        <h1>Ingresa los datos</h1>
               <form class="w3-container w3-card-4 w3-padding-16 w3-white" action="Registrar" method="post" target="_self">
                   <div class="w3-group">      
      ...
      <div class="w3-group">      
        <label class="w3-label">Correo electronico</label>
        <input class="w3-input" type="text" name="mail" required>
      </div>
      
      <button type="submit" class="w3-btn w3-right w3-theme">Registrar usuario</button>
